...
if(isset($_POST['del'])){
	...
	$tt = "DELETE FROM `tc_enquiry` WHERE `id` = '$id' AND `login_id` = '$login_id'";
            ...
            <div class="col-md-12">	
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>Enquiry Message</b></h3>
					</div>
					<div class="box-body box box-info">
						...
						<table class="table table-bordered example1">
							...
							<tbody>
								<?php
									$vv1 = "SELECT * FROM `tc_enquiry` WHERE `domain_id` = '$login_id' ORDER BY id DESC";
