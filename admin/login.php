<?php session_start(); include '../dbconnect.php';
	if(isset($_POST['signin']))
	{
		...
		$query_ad1 = "SELECT * FROM `login` WHERE username = '$user_id' AND  password = '$pwd' AND `role` = 'admin' AND `status` = '1' ";
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo" style="margin-bottom: 0px;background: linear-gradient(0.25turn, #3f87a6, #ebf8e1, #f69d3c);border-radius: 22px 22px 0 0px;font-weight: bold;">
			<a class="logo-name" href="index.php"><span style=" color:#000;">Admin Panel</span></a>
		</div>
